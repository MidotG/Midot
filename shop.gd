...
#///TODO: вначале подобрать текстуры для пола и препятствий(примерно пиксельные) и сделать уровни. 
#///И сделать цену, урон балансную всем оружиям, и параметры всем врагам тоже сбалансить.
#///Сделать привязку камеры к уровню(к границам, чтобы у каждого уровня разные границы камеры в связи с размерами ее были).

#//1-4 уровни земля и трава, деревья, камни, пеньки и озера, реки.
#//5-8 песок, камни, здания, и ящики, и вода.
#//9-10 черный песок и пустота.
