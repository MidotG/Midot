...
#///TODO: добавить esc в менюшках.

#///TODO: потом вначале подобрать текстуры для пола и препятствий(примерно пиксельные) и сделать уровни. И сделать цену, урон балансную всем оружиям, и параметры всем врагам тоже сбалансить.
